...
public class HouseDTOImpl {
	...
	public static void main(String[] args) {
	  ...
	  //ref.compareto(ref2);//-2
	    ...
	    System.out.println("Print all elements where Owning Type is Lease\n");
	    list.stream().filter((ref)->ref.getOwntype()==OwningType.LEASE).forEach((ref)->System.out.println(ref));
	    
	    System.out.println("Print all elements where  Type is Apartment\n");
	    list.stream().filter((ref)->ref.getType()==Type.APARTMENTS).forEach((ref)->System.out.println(ref));
	    
	    System.out.println("Print all elements where  Type is Villa\n");
	    list.stream().filter((ref)->ref.getType()==Type.VILLA).forEach((ref)->System.out.println(ref));
	    
	    System.out.println("Print all elements order by  Type and owning type in Ascending Order\n");
	    list.stream().filter((ref1,ref2)->ref1.get
